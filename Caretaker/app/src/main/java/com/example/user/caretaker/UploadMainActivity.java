...
public class UploadMainActivity extends Activity{
    ...
    private void launchCropActivity(Uri uri){
        Intent crop = new Intent(UploadMainActivity.this,CropSecondActivity.class);
        crop.putExtra("patient_id",id_p);
        crop.putExtra("caretaker_id",id_c);
        crop.putExtra("imageUri", fileUri.toString());
        crop.putExtra("Uri",fileUri);
        startActivity(crop);
    }
