 ...
 */
public class Accelerometer2Activity extends Activity{
    String id_p;
    // Vertical Line
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.accelerometer2page);
        ...
        final EditText noiseEditText = (EditText) findViewById(R.id.noiseET2);
        ...
        add_h.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Accelerometer2Activity.this, "Send data success", Toast.LENGTH_SHORT).show();
        ...
        noiseButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                NOISE = Float.parseFloat(noiseEditText.getText().toString());
                ...
                Toast.makeText(Accelerometer2Activity.this, "Exercise Difficulty Value : " + NOISE, Toast.LENGTH_SHORT).show();
    ...
    public void onResume() {
        super.onResume();
        sensorManager.registerListener(accelListener, sensor,400000);
    }
